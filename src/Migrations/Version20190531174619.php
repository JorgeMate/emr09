 ...
 */
final class Version20190531174619 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE opera (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, treatment_id INT NOT NULL, place_id INT DEFAULT NULL, user_id INT NOT NULL, note_id INT DEFAULT NULL, created_at DATETIME NOT NULL, made_at DATETIME DEFAULT NULL, value DOUBLE PRECISION NOT NULL, INDEX IDX_DFDFF46C6B899279 (patient_id), INDEX IDX_DFDFF46C471C0366 (treatment_id), INDEX IDX_DFDFF46CDA6A219 (place_id), INDEX IDX_DFDFF46CA76ED395 (user_id), INDEX IDX_DFDFF46C26ED0855 (note_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE center (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, contact_person VARCHAR(255) DEFAULT NULL, tel VARCHAR(63) DEFAULT NULL, email VARCHAR(255) NOT NULL, address VARCHAR(127) DEFAULT NULL, postcode VARCHAR(31) DEFAULT NULL, city VARCHAR(63) DEFAULT NULL, enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, slug VARCHAR(255) NOT NULL, ssaas_account_name VARCHAR(127) DEFAULT NULL, ssaas_api_key VARCHAR(127) DEFAULT NULL, UNIQUE INDEX UNIQ_40F0EB245E237E06 (name), UNIQUE INDEX UNIQ_40F0EB24A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE center_doc_group (id INT AUTO_INCREMENT NOT NULL, center_id INT DEFAULT NULL, name VARCHAR(127) NOT NULL, INDEX IDX_A0055215932F377 (center_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_doc (id INT AUTO_INCREMENT NOT NULL, center_doc_group_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, doc_size INT NOT NULL, updated_at DATETIME NOT NULL, mime_type VARCHAR(127) DEFAULT NULL, INDEX IDX_6D579CEF980240FC (center_doc_group_id), INDEX IDX_6D579CEFA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE center_doc_group ADD CONSTRAINT FK_A0055215932F377 FOREIGN KEY (center_id) REFERENCES center (id)');
        $this->addSql('ALTER TABLE user_doc ADD CONSTRAINT FK_6D579CEF980240FC FOREIGN KEY (center_doc_group_id) REFERENCES center_doc_group (id)');
        $this->addSql('ALTER TABLE user_doc ADD CONSTRAINT FK_6D579CEFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE center_doc_group DROP FOREIGN KEY FK_A0055215932F377');
        ...
        $this->addSql('ALTER TABLE user_doc DROP FOREIGN KEY FK_6D579CEF980240FC');
        ...
        $this->addSql('ALTER TABLE user_doc DROP FOREIGN KEY FK_6D579CEFA76ED395');
        ...
        $this->addSql('DROP TABLE center_doc_group');
        $this->addSql('DROP TABLE user_doc');
