 ...
 */
final class Version20190509001525 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_doc (id INT AUTO_INCREMENT NOT NULL, centerdocgroup_id INT DEFAULT NULL, user_id INT DEFAULT NULL, doc_name VARCHAR(255) NOT NULL, doc_size INT NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_6D579CEF13D2BB40 (centerdocgroup_id), INDEX IDX_6D579CEFA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_doc ADD CONSTRAINT FK_6D579CEF13D2BB40 FOREIGN KEY (centerdocgroup_id) REFERENCES center_doc_group (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_doc DROP FOREIGN KEY FK_6D579CEF13D2BB40');
