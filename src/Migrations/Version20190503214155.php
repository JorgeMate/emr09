 ...
 */
final class Version20190503214155 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stored_img (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, image_name VARCHAR(255) NOT NULL, image_size INT NOT NULL, updated_at DATETIME NOT NULL, mime_type VARCHAR(127) NOT NULL, INDEX IDX_C2E1F60F6B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD center_id INT NOT NULL, ADD firstname VARCHAR(127) DEFAULT NULL, ADD lastname VARCHAR(127) NOT NULL, ADD tel VARCHAR(63) DEFAULT NULL, ADD enabled TINYINT(1) NOT NULL, ADD created_at DATETIME NOT NULL, ADD date_of_birth DATE DEFAULT NULL, ADD password_requested_at DATETIME DEFAULT NULL, ADD confirmation_token VARCHAR(180) DEFAULT NULL, ADD medic TINYINT(1) DEFAULT NULL, ADD cod VARCHAR(3) DEFAULT NULL, ADD title VARCHAR(15) DEFAULT NULL, ADD speciality VARCHAR(127) DEFAULT NULL, ADD internal TINYINT(1) DEFAULT NULL, ADD tax_code VARCHAR(63) DEFAULT NULL, ADD reg_code1 VARCHAR(63) DEFAULT NULL, ADD reg_code2 VARCHAR(63) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP center_id, DROP firstname, DROP lastname, DROP tel, DROP enabled, DROP created_at, DROP date_of_birth, DROP password_requested_at, DROP confirmation_token, DROP medic, DROP cod, DROP title, DROP speciality, DROP internal, DROP tax_code, DROP reg_code1, DROP reg_code2');
    }
}
